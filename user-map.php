    ...
    <script>
        ...
        var addMarker = google.maps.event.addListener(map, 'click', function(e) {
            ...
            var marker = new google.maps.Marker({
                ...
                "            <tr>\n" +
                "                <td><a>Aprašymas:</a></td>\n" +
                "                <td><textarea  id='manual_description' placeholder='Aprašymas'></textarea></td></tr>\n" +
                "            <tr><td></td><td><input type='button' value='Pridėti' onclick='saveData("+lat+","+lng+")'/></td></tr>\n" +
                "        </table>\n" +
                "    </div>"
            });
        ...
        for (i = 0; i < locations.length; i++) {
            marker = new google.maps.Marker({
                ...
                "<tr>\n" +
                "<td><a>Aprašymas:</a></td>\n" +
                "<td><textarea disabled id='manual_description' placeholder='Aprašymas'>"+locations[i][3]+"</textarea></td></tr>\n" +
                "</table>\n" +
                "</div>"
            });
